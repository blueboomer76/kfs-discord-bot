...
module.exports = {
	...
	getDuration: ts => {
		...
		if (tDiff < 60) {
			...
			baseStr = Math.floor(tDiff / 60) + " minutes, " + Math.round(tDiff % 60) + " seconds"
		} else if (tDiff < 86400) {
			baseStr = Math.floor(tDiff / 3600) + " hours, " + Math.floor((tDiff % 3600) / 60) + " minutes"
		} else if (tDiff < 2592000) {
			baseStr = Math.floor(tDiff / 86400) + " days, " + Math.floor((tDiff % 86400) / 3600) + " hours"
		} else {
